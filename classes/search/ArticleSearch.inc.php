...
class ArticleSearch {
	...
	function _parseQueryInternal($signTokens, $tokens, &$pos, $total) {
		...
		$notOperator = String::strtolower(PKPLocale::translate('search.operator.not'));
		$andOperator = String::strtolower(PKPLocale::translate('search.operator.and'));
		$orOperator = String::strtolower(PKPLocale::translate('search.operator.or'));
		while ($pos < $total) {
