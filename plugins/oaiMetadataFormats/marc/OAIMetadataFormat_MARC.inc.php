...
class OAIMetadataFormat_MARC extends OAIMetadataFormat {
	...
	function toXml(&$record, $format = null) {
		...
		$response = "<oai_marc status=\"c\" type=\"a\" level=\"m\" encLvl=\"3\" catForm=\"u\"\n" .
			...
			$this->formatElement('540', ' ', ' ', 'a', PKPLocale::translate('submission.copyrightStatement', array('copyrightYear' => $article->getCopyrightYear(), 'copyrightHolder' => $article->getLocalizedCopyrightHolder()))) .
			"</oai_marc>\n";
