{**
 * @file plugins/importexport/crossrefbb/templates/settings.tpl
 *
...
<div id="crossrefSettings">
	...
	<div id="description"><b>{translate key="plugins.importexport.crossrefbb.settings.form.description"}</b></div>
	...
	<form method="post" action="{plugin_url path="settings"}">
		<table width="100%" class="data">
			...
			<tr><td colspan="2">&nbsp;</td></tr>
			<tr valign="top">
				<td width="20%" class="label">{fieldLabel name="username" key="plugins.importexport.crossrefbb.settings.form.username"}</td>
				<td width="80%" class="value">
