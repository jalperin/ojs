{**
 * @file plugins/importexport/crossrefbbe/templates/all.tpl
 *
 ...
 *}
{strip}
{assign var="pageTitle" value="plugins.importexport.crossrefbb.export.selectUnregistered"}
{assign var="pageCrumbTitle" value="plugins.importexport.crossrefbb.export.selectUnregistered"}
...
<div id="allUnregistered">
	<form action="{plugin_url path="exportAll"}" method="post" id="exportAllForm">
		<table width="100%" class="listing">
			...
			{if $noObjects}
				<tr>
					<td colspan="5" class="nodata">{translate key="plugins.importexport.crossrefbb.export.noUnregistered"}</td>
				</tr>
				<tr>
