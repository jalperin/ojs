{**
 * @file plugins/importexport/crossrefbb/templates/index.tpl
 *
 ...
 *}
{strip}
{assign var="pageTitle" value="plugins.importexport.crossrefbb.displayName"}
...
{if empty($configurationErrors)}
	...
	<ul class="plain">
		<li>&#187; <a href="{plugin_url path="all"}">{translate key="plugins.importexport.crossrefbb.export.unregistered"}</a></li>
